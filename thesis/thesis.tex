...
The other approach for block sorting is to find a compatible set for the order graph. We know that maximum non-crossing edge set for $\pi$ is a compatible edge set.
